...
REGION='us-east-1'
KVS_STREAM01_NAME = 'Intruder-detection-video-stream'   # Stream must be in specified region
            ...
            for i in range(len(ndarray_frames)):
                ...
                for label in response['Labels']:
                    if label['Name'] in ['Person']:
                        ...
                        s3_client.upload_fileobj(bytes_io, 'brian-intruder-detection-bucket', 'detections/{}_{}.jpg'.format(self.last_good_fragment_tags['AWS_KINESISVIDEO_FRAGMENT_NUMBER'], str(i * one_in_frames_ratio)))
